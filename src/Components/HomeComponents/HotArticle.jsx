 ...
 if (isLoading)
  return (
   <>
    ...
    <p>If this is your first time on the site the back-end may take approx 1 minute to load</p>
   </>
  );
 return (
  <>
    ...
    <li key={randomArticle.article_id} className="random-article-card">
     ...
     <div className="icon-wrapper">
      ...
      <p className="random-article-votes">
       <img className="votes-icon" src="/votesicon.png" alt="icon representing votes" /> {randomArticle.votes}
      </p>
     </div>
